      ...
      {open && (
        <div className="fixed inset-0 z-50">
          ...
          <motion.aside
            ...
            animate={{ x: 0 }}
            exit={{ x: "100%" }}
            transition={{ type: "tween", duration: 0.35, ease: [0.2, 0.6, 0.2, 1] }}
            className="absolute inset-y-0 right-0 flex w-[90%] max-w-md flex-col bg-background shadow-2xl sm:w-full"
          >
            ...
            {items.length === 0 ? (
              <div className="flex flex-1 flex-col items-center justify-center gap-4 px-6 text-center">
                ...
                <button
                  onClick={() => setOpen(false)}
                  className="rounded-2xl bg-primary px-6 py-3 text-sm font-medium text-primary-foreground hover:bg-[#333] transition-colors"
                >
                  Continuar comprando
                </button>
              </div>
                      ...
                      <div className="flex flex-1 flex-col">
                        ...
                        <div className="mt-auto flex items-center justify-between">
                          <div className="flex items-center rounded-full border border-border">
                            <button onClick={() => update(i.product.id, i.qty - 1)} className="p-2">
                ...
                <div className="border-t border-border p-6">
                  <div className="space-y-4">
                    <div className="flex gap-2">
                      ...
                      />
                      <button className="rounded-2xl border border-border px-4 text-sm hover:bg-secondary font-medium transition-colors">
                        Aplicar
                      </button>
                    </div>
