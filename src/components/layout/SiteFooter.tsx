...
export function SiteFooter() {
  ...
  return (
    <footer
      data-editor-block="footer"
      className="mt-24"
      style={{ background: "var(--tp-footer-bg)", color: "var(--tp-footer-text)" }}
    >
      <div className="container-x py-16">
        <div className="grid gap-12 md:grid-cols-4">
            ...
            <div className="mt-6 flex gap-3">
              {f.instagram && (
                <a
                  ...
                  className="rounded-full border border-white/15 p-2.5 hover:bg-primary hover:border-primary transition"
                >
          ...
          <FooterCol
            title="ajuda"
            links={[
              ["trocas e devoluções", "/politica-de-trocas"],
...
function FooterCol({ title, links }: { title: string; links: [string, string][] }) {
  return (
    <div>
      ...
      <ul className="mt-4 space-y-3 text-sm lowercase opacity-80">
        {links.map(([l, to]) => (
          <li key={l}>
