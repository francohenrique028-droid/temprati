...
export const Route = createFileRoute("/admin/login")({
  head: () => ({ meta: [{ title: "Entrar · Admin #temprati" }, { name: "robots", content: "noindex" }] }),
  component: LoginPage,
});
    ...
    <div className="min-h-screen flex items-center justify-center bg-neutral-50 px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <div className="mt-1 text-xs uppercase tracking-[0.2em] text-neutral-500">painel administrativo</div>
        </div>
        <form onSubmit={handleSubmit} className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
          ...
          {password && !passwordValid && <p className="mt-1 text-xs text-red-600">Mínimo 6 caracteres</p>}
