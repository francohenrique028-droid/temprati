  ...
  return (
    <SiteLayout>
      <div className="container-x py-40 text-center">
        ...
        <a
          href="/"
          className="mt-8 inline-block rounded-2xl bg-primary px-6 py-3 text-sm font-medium text-primary-foreground hover:bg-[#333]"
        >
          Voltar para a loja
        </a>
      </div>
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <button
          ...
          className="mt-6 rounded-2xl bg-primary px-6 py-3 text-sm font-medium text-primary-foreground hover:bg-[#333]"
        >
          Tentar de novo
        </button>
      </div>
  ...
  head: () => ({
    meta: [
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/d5fa327b-3b26-48cb-aef7-717f1a9cc99a/id-preview-d0693197--083afbce-13b9-4824-952e-5ca958b47091.lovable.app-1784916962372.png",
      },
      {
        name: "twitter:image",
        content:
