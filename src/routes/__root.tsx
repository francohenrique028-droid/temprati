  ...
  return (
    <SiteLayout>
      <div className="container-x py-40 text-center">
        ...
        <a href="/" className="mt-8 inline-block rounded-2xl bg-primary px-6 py-3 text-sm font-medium text-primary-foreground hover:bg-[#333]">
          Voltar para a loja
        </a>
      </div>
    </SiteLayout>
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <button onClick={() => { router.invalidate(); reset(); }} className="mt-6 rounded-2xl bg-primary px-6 py-3 text-sm font-medium text-primary-foreground hover:bg-[#333]">
          Tentar de novo
        </button>
      </div>
    </div>
