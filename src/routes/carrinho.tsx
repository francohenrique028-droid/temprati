    ...
    <div className="container-x py-14">
      ...
      {items.length === 0 ? (
        <div className="py-20 text-center">
          ...
          <Link
            to="/"
            className="mt-6 inline-block rounded-2xl bg-primary px-6 py-3 text-xs uppercase tracking-[0.2em] text-primary-foreground hover:bg-[#333]"
          >
            Continuar comprando
          </Link>
        </div>
        ...
        <div className="mt-10 grid gap-10 lg:grid-cols-[1fr_380px]">
          ...
          <aside className="rounded-2xl border border-border bg-card p-6 lg:sticky lg:top-32 lg:self-start">
            ...
            <Link
              to="/checkout"
              className="mt-6 block rounded-2xl bg-primary py-4 text-center text-xs font-medium uppercase tracking-[0.2em] text-primary-foreground hover:bg-[#333]"
            >
              Finalizar Compra
            </Link>
          </aside>
