...
export const Route = createFileRoute("/politica-de-privacidade")({
  ...
  component: () => (
    <div className="container-x max-w-3xl py-20 space-y-6 text-sm leading-relaxed text-foreground/85">
      ...
      <p>
        Respeitamos sua privacidade. Coletamos apenas dados necessários para processar seu pedido e
        melhorar sua experiência.
      </p>
      <p>
        Seus dados nunca são compartilhados com terceiros para fins de marketing sem seu
