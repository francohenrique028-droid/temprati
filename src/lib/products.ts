...
export const products: Product[] = [
  { id:"1", slug:"vestido-midi-rose", name:"Conjunto Camurça", category:"vestidos", collection:"lancamentos", brand:"temprati", price:289, oldPrice:349, badge:"Best Seller", images:[vestidoMidiRose.url, vestidoMidiRose.url], colors:["hsl(335 75% 82%)"], sizes:["PP","P","M","G"], bestseller:true, description:"Vestido midi em tecido fluido, corte alinhado e caimento impecável." },
  ...
  { id:"3", slug:"blusa-cropped-tricot", name:"colete de alfaiataria", category:"blusas", collection:"bestsellers", brand:"temprati", price:89, oldPrice:119, badge:"Promoção", images:[croppedTricotRosa.url], colors:["hsl(335 75% 82%)"], sizes:["Único"], bestseller:true, description:"Colete de alfaiataria com caimento estruturado e acabamento refinado.", video: croppedTricotRosaVideo.url },
  { id:"4", slug:"calca-alfaiataria-wide", name:"Vestido De Linho Midi Branco", category:"feminino", collection:"bestsellers", brand:"temprati", price:129, images:[calcaAlfaiatariaWide.url, calcaAlfaiatariaWide.url], colors:["hsl(335 70% 96%)"], sizes:["36","38","40","42"], bestseller:true, description:"Vestido midi em linho branco, caimento fluido e acabamento refinado." },
  { id:"5", slug:"saia-plissada-rose", name:"saia plissada rose", category:"feminino", collection:"lancamentos", brand:"temprati", price:79, images:[prod5, prod8], colors:["hsl(335 75% 82%)"], sizes:["P","M","G"], isNew:true, badge:"Novo", description:"Saia plissada em tecido leve, movimento fluido e look feminino." },
  { id:"6", slug:"conjunto-blazer-calca", name:"Conjunto Urbana Chic", category:"conjuntos", collection:"bestsellers", brand:"temprati", price:459, oldPrice:589, badge:"Promoção", images:[conjuntoBlazerCalca.url], colors:["hsl(335 75% 82%)"], sizes:["PP","P","M","G"], bestseller:true, description:"Conjunto alfaiataria com blazer estruturado e calça reta. Look completo pronto para usar." },
  { id:"7", slug:"bolsa-couro-rose", name:"bolsa couro rose", category:"acessorios", collection:"lancamentos", brand:"temprati", price:329, images:[prod7, prod2], colors:["hsl(335 75% 82%)"], sizes:["Único"], isNew:true, badge:"Novo", description:"Bolsa em couro sintético premium, alça ajustável e acabamento impecável." },
  { id:"8", slug:"tenis-branco-minimal", name:"tênis branco minimal", category:"calcados", collection:"bestsellers", brand:"temprati", price:99, oldPrice:139, badge:"Best Seller", images:[tenisBrancoMinimal.url], colors:["hsl(335 70% 90%)"], sizes:["34","35","36","37","38","39"], bestseller:true, description:"Tênis minimalista em couro sintético, solado macio e visual clean." },
];
