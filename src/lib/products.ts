...
export const products: Product[] = [
  ...
  { id:"3", slug:"blusa-cropped-tricot", name:"cropped tricot rosa", category:"blusas", collection:"bestsellers", brand:"temprati", price:89, oldPrice:119, badge:"Promoção", images:[croppedTricotRosa.url], colors:["#EC4899"], sizes:["Único"], bestseller:true, description:"Cropped em tricot leve, modelagem soltinha e acabamento delicado.", video: croppedTricotRosaVideo.url },
  { id:"4", slug:"calca-alfaiataria-wide", name:"calça alfaiataria wide", category:"feminino", collection:"bestsellers", brand:"temprati", price:129, images:[calcaAlfaiatariaWide.url, calcaAlfaiatariaWide.url], colors:["#FFE4EC"], sizes:["36","38","40","42"], bestseller:true, description:"Calça de alfaiataria com pernas amplas, cintura alta e caimento estruturado." },
  ...
  { id:"6", slug:"conjunto-blazer-calca", name:"conjunto blazer + calça", category:"conjuntos", collection:"bestsellers", brand:"temprati", price:459, oldPrice:589, badge:"Promoção", images:[conjuntoBlazerCalca.url], colors:["#F472B6"], sizes:["PP","P","M","G"], bestseller:true, description:"Conjunto alfaiataria com blazer estruturado e calça reta. Look completo pronto para usar." },
  { id:"7", slug:"bolsa-couro-rose", name:"bolsa couro rose", category:"acessorios", collection:"lancamentos", brand:"temprati", price:329, images:[prod7, prod2], colors:["#F472B6"], sizes:["Único"], isNew:true, badge:"Novo", description:"Bolsa em couro sintético premium, alça ajustável e acabamento impecável." },
  { id:"8", slug:"tenis-branco-minimal", name:"tênis branco minimal", category:"calcados", collection:"bestsellers", brand:"temprati", price:99, oldPrice:139, badge:"Best Seller", images:[tenisBrancoMinimal.url], colors:["#FFC1D9"], sizes:["34","35","36","37","38","39"], bestseller:true, description:"Tênis minimalista em couro sintético, solado macio e visual clean." },
];
