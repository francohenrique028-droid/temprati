...
export const products: Product[] = [
  ...
  { id:"4", slug:"calca-alfaiataria-wide", name:"Vestido De Linho Midi Branco", category:"feminino", collection:"bestsellers", brand:"temprati", price:129, images:[calcaAlfaiatariaWide.url, calcaAlfaiatariaWide.url], colors:["#FFE4EC"], sizes:["36","38","40","42"], bestseller:true, description:"Vestido midi em linho branco, caimento fluido e acabamento refinado." },
