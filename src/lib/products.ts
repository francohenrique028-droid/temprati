...
export const products: Product[] = [
  ...
  { id:"5", slug:"saia-plissada-rose", name:"saia plissada rose", category:"feminino", collection:"lancamentos", brand:"temprati", price:79, images:[prod5, prod8], colors:["hsl(28 67% 80%)"], sizes:["P","M","G"], isNew:true, badge:"Novo", description:"Saia plissada em tecido leve, movimento fluido e look feminino." },
